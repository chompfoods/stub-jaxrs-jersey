...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2020-01-27T21:16:22.689Z[GMT]")public class FoodApiServiceImpl extends FoodApiService {
    @Override
    ...
    @Override
    public Response foodBrandedNamePhpGet( @NotNull String name,  Integer limit,  Integer page, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    ...
    @Override
    public Response foodIngredientSearchPhpGet( @NotNull Integer find,  Boolean raw,  Integer limit, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
