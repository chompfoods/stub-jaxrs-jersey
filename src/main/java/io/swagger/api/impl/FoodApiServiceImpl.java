...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2020-01-27T21:18:02.311Z[GMT]")public class FoodApiServiceImpl extends FoodApiService {
    @Override
    ...
    @Override
    public Response foodIngredientSearchPhpGet( @NotNull String find,  Boolean raw,  Integer limit, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
